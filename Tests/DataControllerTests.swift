...
class DataControllerTests: BaseTestCase {
    func testSampleData() throws {
        ...
        XCTAssertEqual(dataController.count(for: User.fetchRequest()), 50, "There should be 50 users in the sample data.")
    ...
    func testDeleteAll() throws {
        ...
        XCTAssertEqual(dataController.count(for: User.fetchRequest()), 0, "There should be no users left over.")
